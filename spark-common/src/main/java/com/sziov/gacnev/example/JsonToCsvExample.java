...
public class JsonToCsvExample {
    ...
    private static final String INPUT_JSON_PATH = "spark-common/data/input/users.json";
    private static final String OUTPUT_CSV_PATH = "spark-common/data/output/users.csv";
