...
public final class ParamsKeyConstant {
    ...
    public static final String DATASOURCE_ES_INDEX_AUTO_CREATE = "datasource.es.index.auto.create";
    /** Elasticsearch 端口 */
    public static final String DATASOURCE_ES_PORT = "datasource.es.port";
    // ClickHouse
    /** ClickHouse 连接地址 */
    public static final String DATASOURCE_CK_HOSTS = "datasource.ck.hosts";
    /** ClickHouse 用户名 */
    public static final String DATASOURCE_CK_USERNAME = "datasource.ck.username";
    /** ClickHouse 密码 */
    public static final String DATASOURCE_CK_PASSWORD = "datasource.ck.password";
    /** ClickHouse 批量写入大小 */
    public static final String DATASOURCE_CK_BATCH_SIZE = "datasource.ck.batch.size";
    // MongoDB
    /** MongoDB 连接 URI */
    public static final String DATASOURCE_MONGO_URI = "datasource.mongo.uri";
    /** MongoDB 数据库名 */
    public static final String DATASOURCE_MONGO_DATABASE = "datasource.mongo.database";
    // Redis
    /** Redis 主机地址 */
    public static final String DATASOURCE_REDIS_HOST = "datasource.redis.host";
    /** Redis 端口 */
    public static final String DATASOURCE_REDIS_PORT = "datasource.redis.port";
    /** Redis 认证密码 */
